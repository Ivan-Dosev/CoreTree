...
public class PNG13_View: UIView {
    ...
    private func createPngTreva() {
        pngTreva = UIImageView(frame: CGRect(x: 190.08, y: 306.68, width: 379.84, height: 145.37))
        ...
        pngTreva.layer.position = CGPoint(x: 190.08, y: 306.68)
        pngTreva.layer.bounds = CGRect(x: 0, y: 0, width: 379.84, height: 145.37)
